class Ann.Graph5
  @draw: (client) ->
    allStatuses = new Keen.Query "count",
    ...
    pcStatuses = new Keen.Query "count",
      eventCollection: "statuses"
      timeframe: "this_90_days"
      interval: "daily"
      filters: [{
    ...
    mobileStatuses = new Keen.Query "count",
      eventCollection: "statuses"
      timeframe: "this_90_days"
      interval: "daily"
      filters: [{
    ...
    client.run [allStatuses, pcStatuses, mobileStatuses], (err, res) ->
